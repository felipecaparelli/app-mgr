function wizardController($scope, $routeParams, $templateCache, WizardService) {
	...
	init = function() {
		...
		vm.appform = {};
		vm.appform.ec2list = [];
		vm.appform.ec2keys = [ 'Type', 'Enviroments', 'OperatingSystem', 'Delete' ];

		$scope.itemId = $routeParams.itemId;
		if ($scope.itemId != null && $scope.itemId != '' && $scope.itemId != undefined) {
